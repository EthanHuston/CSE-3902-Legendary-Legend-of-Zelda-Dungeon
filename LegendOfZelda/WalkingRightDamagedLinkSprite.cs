...
namespace Sprint0
{
    class WalkingRightDamagedLinkSprite : ISprite
    {
        ...
        public WalkingRightDamagedLinkSprite(Texture2D sprite)
        {
            this.sprite = sprite;
        ...
        public void Update()
        {
            ...
            xPos += xPos < Constants.MaxXPos ? Constants.LinkWalkDistance : 0;
            */
        }
