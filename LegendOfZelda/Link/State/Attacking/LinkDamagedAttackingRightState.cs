...
{
    class LinkDamagedAttackingRightState : ILinkState
    {
        private Link link;
        private DateTime healthyDateTime;

        public LinkDamagedAttackingRightState(Link link)
        {
            InitClass(link);
        }
        public LinkDamagedAttackingRightState(Link link, int damage)
        {
            InitClass(link);
        ...
        public LinkDamagedAttackingRightState(Link link, DateTime healthyDateTime)
        {
            InitClass(link);
        ...
        {
            // Already attacking right, do nothing
        }
