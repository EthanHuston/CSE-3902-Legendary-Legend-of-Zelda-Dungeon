...
namespace LegendOfZelda.Link.State.Attacking
{
    class LinkAttackingLeftState : ILinkState
    {
        ...
        public LinkAttackingLeftState(LinkPlayer link)
        {
            InitClass(link);
            damaged = false;
        ...
        public LinkAttackingLeftState(LinkPlayer link, bool damaged, DateTime healthyDateTime)
        {
            InitClass(link);
        ...
        public void Draw()
        {
            float posX = link.GetPosition().X + Constants.LinkUsingSwordLeftSpawnOffsetX;
            float posY = link.GetPosition().Y + Constants.LinkUsingSwordLeftSpawnOffsetY;
