...
{
    class LinkDamagedAttackingUpState : ILinkState
    {
        private Link link;
        private DateTime healthyDateTime;

        public LinkDamagedAttackingUpState(Link link)
        {
            InitClass(link);
        }
        public LinkDamagedAttackingUpState(Link link, int damage)
        {
            InitClass(link);
        ...
        public LinkDamagedAttackingUpState(Link link, DateTime healthyDateTime)
        {
            InitClass(link);
        ...
        {
            this.link = link;
            this.link.CurrentSprite = SpriteFactory.Instance.CreateStrikingUpDamagedLinkSprite();
        }
