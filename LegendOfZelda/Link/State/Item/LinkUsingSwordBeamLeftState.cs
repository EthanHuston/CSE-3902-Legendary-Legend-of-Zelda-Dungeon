...
{
    class LinkUsingSwordBeamLeftState : ILinkState
    {
        private LinkPlayer link;
        private bool damaged;
        private DateTime healthyDateTime;

        public LinkUsingSwordBeamLeftState(LinkPlayer link)
        {
            InitClass(link);
            damaged = false;
        ...
        public LinkUsingSwordBeamLeftState(LinkPlayer link, bool damaged, DateTime healthyDateTime)
        {
            InitClass(link);
        ...
        private void InitClass(LinkPlayer link)
        {
            ...
            this.link.SpawnItem(new SwordBeamItem(link, Constants.Direction.Left));
        }
