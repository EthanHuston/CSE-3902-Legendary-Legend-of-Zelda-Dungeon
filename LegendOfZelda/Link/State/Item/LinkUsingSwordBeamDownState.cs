...
{
    internal class LinkUsingSwordBeamDownState : LinkLazyAbstractState
    {
        ...
        {
            link.SpawnItem(new SwordBeamFlyingProjectile(link.Game.SpriteBatch, link.Position, Constants.ItemOwner.Link, Constants.Direction.Down));
