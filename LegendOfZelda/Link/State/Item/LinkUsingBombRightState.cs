...
{
    class LinkUsingBombRightState : ILinkState
    {
        private LinkPlayer link;
        private bool damaged;
        private DateTime healthyDateTime;

        public LinkUsingBombRightState(LinkPlayer link)
        {
            InitClass(link);
            damaged = false;
        ...
        public LinkUsingBombRightState(LinkPlayer link, bool damaged, DateTime healthyDateTime)
        {
            InitClass(link);
