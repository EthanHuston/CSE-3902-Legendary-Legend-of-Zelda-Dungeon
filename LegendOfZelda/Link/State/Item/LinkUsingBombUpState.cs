...
{
    class LinkUsingBombUpState : ILinkState
    {
        private LinkPlayer link;
        private bool damaged;
        private DateTime healthyDateTime;

        public LinkUsingBombUpState(LinkPlayer link)
        {
            InitClass(link);
            damaged = false;
        ...
        public LinkUsingBombUpState(LinkPlayer link, bool damaged, DateTime healthyDateTime)
        {
            InitClass(link);
