...
{
    class LinkUsingBoomerangRightState : ILinkState
    {
        private LinkPlayer link;
        private bool damaged;
        private DateTime healthyDateTime;

        public LinkUsingBoomerangRightState(LinkPlayer link)
        {
            InitClass(link);
            damaged = false;
        ...
        public LinkUsingBoomerangRightState(LinkPlayer link, bool damaged, DateTime healthyDateTime)
        {
            InitClass(link);
        ...
        private void InitClass(LinkPlayer link)
        {
            ...
            this.link.SpawnItem(new BoomerangFlyingItem(link, Constants.Direction.Right));
        }
