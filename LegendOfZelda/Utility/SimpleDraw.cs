...
namespace LegendOfZelda.Utility
{
    static class SimpleDraw
    {
        ...
        {
            spriteBatch.Draw(sprite, destinationRectangle, sourceRectangle, color, rotation, rotationOrigin, effects, layer);
        }
        ...
        {
            spriteBatch.Draw(sprite, destinationRectangle, sourceRectangle, color, 0, Vector2.Zero, default, layer);
        }
    }
}
