...
{
    internal class ArrowWoodInventoryButton : IButton
    {
        ...
        public ArrowWoodInventoryButton(SpriteBatch spriteBatch, IMenu owner, Point relativePosition)
        {
        ...
        public void Draw()
        {
            sprite.Draw(spriteBatch, owningMenu.Position + Position, GameStateConstants.ArrowWoodTextureAtlasSource, Constants.DrawLayer.MenuButton);
        }
