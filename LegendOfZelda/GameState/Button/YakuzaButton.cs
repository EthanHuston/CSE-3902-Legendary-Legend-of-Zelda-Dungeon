...
namespace LegendOfZelda.GameState.Button
{
    class YakuzaButton : IOnOffButton
    {
        ...
        public YakuzaButton(SpriteBatch spriteBatch, Point spawnPosition)
        {
            ...
            buttonSprite = GameStateSpriteFactory.Instance.CreateYakuzaButtonSprite();
            buttonSelectedSprite = GameStateSpriteFactory.Instance.CreateYakuzaButtonSelectedSprite();
            IsOn = false;
