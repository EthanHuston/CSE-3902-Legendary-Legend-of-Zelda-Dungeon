...
{
    internal class BoomerangWoodInventoryButton : IButton
    {
        ...
        public BoomerangWoodInventoryButton(SpriteBatch spriteBatch, IMenu owner, Point relativePosition)
        {
        ...
        public void Draw()
        {
            sprite.Draw(spriteBatch, owningMenu.Position + Position, GameStateConstants.BoomerangWoodTextureAtlasSource, Constants.DrawLayer.MenuButton);
        }
