...
{
    internal class BackButton : IOnOffButton
    {
        ...
        public BackButton(SpriteBatch spriteBatch, Point spawnPosition)
        {
            this.spriteBatch = spriteBatch;
            sprite = GameStateSpriteFactory.Instance.CreateBackButtonSprite();
