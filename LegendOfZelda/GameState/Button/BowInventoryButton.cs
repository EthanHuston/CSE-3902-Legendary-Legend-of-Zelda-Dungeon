...
{
    internal class BowInventoryButton : IButton
    {
        ...
        public BowInventoryButton(SpriteBatch spriteBatch, IMenu owner, Point relativePosition)
        {
        ...
        public void Draw()
        {
            sprite.Draw(spriteBatch, owningMenu.Position + Position, GameStateConstants.BowTextureAtlasSource, Constants.DrawLayer.MenuButton);
        }
